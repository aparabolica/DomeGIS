...
describe('send kml file to uploads service', function () {
  ...
  it('should post a file', function(doneIt) {
    ...
    chai.request(app)
      ...
      .attach('file', fs.readFileSync(__dirname + '/../../../fixtures/uploads/sample.kml'), 'sample.kml')
      .end(function (err, res) {
